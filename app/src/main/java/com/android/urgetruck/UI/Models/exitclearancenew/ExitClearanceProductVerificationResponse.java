...
public class ExitClearanceProductVerificationResponse {
    ...
    public ExitClearanceProductVerificationResponse(String driverCode, String driverName, String errorMessage, List<ProductDetail> productDetails,
